public class Gryffindor extends Hogwarts {
    ...
    public Gryffindor(String name, int magicPower, int transgressionPower, int nobility, int honor, int bravery) {
    ...
    public void compareGryffindorStudent(Gryffindor gryffindorStudent){
